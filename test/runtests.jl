...
# !!! Main.UserApp is configured as an alias for Main.ImfitTre and you might encounter it in some tests
using Main.ImfitTre, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "ImfitTre tests" begin
  @includetests ARGS
end
